...
//   // final userIdController = TextEditingController(text: '3');
...
//     request.fields['WorkingHours.CompanyId'] = Text('324').toString();
...
//       );
//       request.files.add(
//         await http.MultipartFile.fromPath('ProfilePicture', companyLogo!.path),
//       );
//     }
...
//         context,
//       ).showSnackBar(SnackBar(content: Text('Company Profile Created')));
...
//               child: Text(
//                 workingHoursStart[day]?.format(context) ?? 'Pick Time',
//               ),
//             ),
//             SizedBox(width: 20),
//             Text("End:"),
...
//               child: Text(workingHoursEnd[day]?.format(context) ?? 'Pick Time'),
//             ),
//           ],
//         ),
//       ],
